...
val ped = new BufferedReader(new FileReader(new File("/Users/chhar0/tmp/NL396647605_fam.ped")))
...
//val GTs = new BufferedReader(new InputStreamReader(new BlockCompressedInputStream(new FileInputStream(new File("/home/aeonsim/refs/BBB-seqdHDs.AC1plus.vcf.gz")))))

val GTs = new BufferedReader(new InputStreamReader(new BlockCompressedInputStream(new FileInputStream(new File("/Users/chhar0/tmp/NL396647605_fam.vcf.gz")))))
