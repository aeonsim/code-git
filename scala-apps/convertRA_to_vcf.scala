...
val genos = new BufferedReader(new FileReader("AS_RA__0_0.txt"))
val out = new BufferedWriter(new OutputStreamWriter(new BlockCompressedOutputStream("HD_out_anne-so.vcf.gz")))
